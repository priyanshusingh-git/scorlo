      ...
      <div aria-busy="true" aria-live="polite" className="space-y-5 lg:space-y-6">
        ...
        {variant === "list" ? (
          <>
            ...
            <SkeletonBlock className="h-52 w-full rounded-[1.8rem]" />
            <SkeletonBlock className="h-52 w-full rounded-[1.8rem]" />
            <SkeletonBlock className="h-52 w-full rounded-[1.8rem]" />
          </>
        ) : null}
          ...
          <>
            ...
            <section className="grid grid-cols-1 gap-5 xl:grid-cols-[minmax(0,0.95fr)_minmax(360px,1.05fr)]">
              <div className="space-y-3">
                <SkeletonBlock className="h-28 w-full rounded-[1.8rem]" />
                <SkeletonBlock className="h-28 w-full rounded-[1.8rem]" />
                <SkeletonBlock className="h-28 w-full rounded-[1.8rem]" />
              </div>
              <SkeletonBlock className="h-[34rem] w-full rounded-[1.8rem]" />
            </section>
          </>
        ) : null}
