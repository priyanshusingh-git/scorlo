  ...
  return (
    <nav
      className={cn(
        ...
        isDense
          ? "max-w-[28rem] justify-between px-2 py-2"
          : isSparse
            ? "max-w-[14rem] justify-center gap-2 px-2 py-2"
            : "max-w-md justify-between px-3 py-2",
    ...
    >
      {items.map(({ href, label, icon: Icon }) => {
        ...
        const locked = lockedItemHrefs.includes(href);
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              isDense
                ? "min-w-0 flex-1 px-1.5 py-2 text-[10px]"
                : isSparse
